...
class VideoProcessor{
	...
	private function insertVideoData($uploadData){
		/*&$durations = $uploadData->durations;
		...
		$query = $this->con->prepare("INSERT INTO videos(title, uploadedBy, description, privacy, category, filePath, duration,funScript,intensity)
										VALUES(:title, :uploadedBy, :description, :privacy, :category, :filePath, :duration,:funScript,:intensity)");

		$query->bindParam(":title", $uploadData->title);
		$query->bindParam(":funScript", $uploadData->funScript);
		$query->bindParam(":uploadedBy", $uploadData->uploadedBy);
		$query->bindParam(":description", $uploadData->description);
		$query->bindParam(":privacy", $uploadData->privacy);
		$query->bindParam(":category", $uploadData->category);
		$query->bindParam(":filePath", $uploadData->videoUrl);
		$query->bindParam(":duration", $uploadData->duration);
		$query->bindParam(":intensity", $uploadData->intensity);
