...
class ProfileGenerator{
	...
	public function createCoverPhotoSection(){
		...
		$name = $this->profileData->getProfileUsername();//getProfileUserFullName();
	...
	public function createTabsSection(){
		return "<ul class='nav nav-tabs' id='profileTab' role='tablist'>
					<li class='nav-item'>
	...
	public function createContentSection(){
		if($this->userLoggedInObj->getUsername() == $this->profileData->getProfileUsername() or $this->userLoggedInObj->getUsername() == 'BasicGirl' ){
			$videos = $this->profileData->getUsersLoggedInVideos();
		}else{
